...
void interface() {
    ...
    while (switcher) {
        ...
        if (switcher == 1) {
            ...
            string LastNames[16]{ "Smirnov", "Frolov", "Nikitin", "Zaharov", "Oleksuk", "Polyakova", "Ershov", "Romanov", "Ilyin", "Grigorieva", "Ivanchenko", "Vinogradov", "Maksimova", "Medvedeva", "Semenov", "Kuzmin" };
            string MiddleNames[16]{ "Pavlovna", "Alexeevich", "Ivanovna", "Vasilievich", "Alekseevna", "Pavlovich", "Olegovich", "Vladimirovich", "Alexandrovich", "Michaelovna", "Mihailovna", "Nikolaevna", "Victorovich", "Pavlovich", "Petrovich", "Zaharovich" };
            ...
            switch (option) {
                case 1:
                    ...
                    for (int i = 0; i < amount; i++) {
                        Person_ = Person(FirstNames[(rand() + i) % 16], MiddleNames[(rand() + i) % 16],
                                         LastNames[(rand() + i) % 16], 1950 + (rand() + i) % 71);
                        seq->Append(Person_);
                        cout << Person_.getFIO() << " ";
            ...
            do {
                ...
                cout << "2. last name histogram" << endl;
                cout << "3. exit" << endl;
                cin >> hist;
                switch(hist){
                    case 1:
                    ...
                    case 2:
                        histogramofpersons = new Histogram();
                        histogramofpersons->LastNameHistogram(seq, gap);
                        cout << "Category - Amount: " << endl;
                        histogramofpersons->print();
                        break;
                }
            ...
            cout << "Choose option" << endl;
            cout << "1. auto generating a string" << endl;
